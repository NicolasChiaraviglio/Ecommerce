...
SECRET_KEY = 'django-insecure-4ga=lxi$+xlzfbowf7x#w$-u&b_2jyr+sv1km=qgf16(z7^l3h'
...
INSTALLED_APPS = [
    ...
    #Agregados para Autenticacion Django
...
AUTHENTICATION_BACKENDS = [
    # Needed to login by username in Django adminm regardless of 'allauth'
